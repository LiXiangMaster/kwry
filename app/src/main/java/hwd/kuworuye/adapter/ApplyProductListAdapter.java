 ...
 */
public class ApplyProductListAdapter extends BaseAdapter {
    private List<SaleApplyDetailBean.ItemListBean> itemList;
    private Context context;

    public ApplyProductListAdapter(Context context, List<SaleApplyDetailBean.ItemListBean> itemList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        SaleApplyDetailBean.ItemListBean.KwProductAttributeBean.ProductBean product = itemList.get(i).getKwProductAttribute().getProduct();
        if (product == null) {
