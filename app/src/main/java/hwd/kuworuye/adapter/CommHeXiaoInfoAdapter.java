 ...
 */
public class CommHeXiaoInfoAdapter extends BaseAdapter {
    private List<SaleActivityXiaoHeDetailBean.RecordListBean> list;
    private Context context;

    public CommHeXiaoInfoAdapter(Context context, List<SaleActivityXiaoHeDetailBean.RecordListBean> recordList) {
