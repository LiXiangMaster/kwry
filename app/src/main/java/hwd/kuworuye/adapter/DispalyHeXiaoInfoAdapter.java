 ...
 */
public class DispalyHeXiaoInfoAdapter extends BaseAdapter {
    private List<DisplayHeXiaoDetailBean.RecordListBean> list;
    private Context context;

    public DispalyHeXiaoInfoAdapter(Context context, List<DisplayHeXiaoDetailBean.RecordListBean> recordList) {
