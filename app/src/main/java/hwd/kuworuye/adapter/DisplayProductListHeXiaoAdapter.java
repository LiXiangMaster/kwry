 ...
 */
public class DisplayProductListHeXiaoAdapter extends BaseAdapter {
    private List<DisplayHeXiaoDetailBean.ItemListBean> itemList;
    private Context context;

    public DisplayProductListHeXiaoAdapter(Context context, List<DisplayHeXiaoDetailBean.ItemListBean> itemList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        DisplayHeXiaoDetailBean.ItemListBean.KwProductAttributeBean.ProductBean product = itemList.get(i).getKwProductAttribute().getProduct();
        if (product == null) {
