 ...
 */
public class JoinSiteHeXiaoAdapter extends BaseAdapter {

    private List<JoinSiteHeXiaoBean.DataBean> list;
    private Context context;

    public JoinSiteHeXiaoAdapter(Context context, List<JoinSiteHeXiaoBean.DataBean> list) {
        this.list = list;
    ...
    public View getView(int i, View conview, ViewGroup viewGroup) {
        ...
        viewHolder.mTvActivityCost.setText("活动费用：¥" + list.get(i).getTotalExpenses());
