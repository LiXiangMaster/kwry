...
public class JoinSiteHxDetailStateAdapter extends BaseAdapter {

    private Context context;
    private List<JoinSiteHxDetailBean.DataBean.ApprovalListBean> approvalList;

    public JoinSiteHxDetailStateAdapter(Context context, List<JoinSiteHxDetailBean.DataBean.ApprovalListBean> approvalList) {
