 ...
 */
public class JoinSiteHxPicMangeAdapter extends BaseAdapter {
    private List<JoinSiteHxDetailBean.DataBean.ScenePhotoListBean> photoList;
    private Context context;

    public JoinSiteHxPicMangeAdapter(Context context, List<JoinSiteHxDetailBean.DataBean.ScenePhotoListBean> photoList) {
