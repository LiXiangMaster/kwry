...
public class OtherCostAyDetailStateAdapter extends BaseAdapter {

    private Context context;
    private List<OtherCostApplyDetailBean.DataBean.ApprovalListBean> approvalList;

    public OtherCostAyDetailStateAdapter(Context context, List<OtherCostApplyDetailBean.DataBean.ApprovalListBean> approvalList) {
