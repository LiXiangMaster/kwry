...
public class OtherCostHxDetailStateAdapter extends BaseAdapter {

    private Context context;
    private List<OtherCostHeXiaoDetailBean.DataBean.ApprovalListBean> approvalList;

    public OtherCostHxDetailStateAdapter(Context context, List<OtherCostHeXiaoDetailBean.DataBean.ApprovalListBean> approvalList) {
    ...
    public View getView(int i, View view, ViewGroup viewGroup) {
        ...
        viewHolder.mTvUserName.setText(approvalList.get(i).getUser().getName()+",");
