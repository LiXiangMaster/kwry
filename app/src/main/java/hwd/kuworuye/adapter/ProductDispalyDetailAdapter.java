 ...
 */
public class ProductDispalyDetailAdapter extends BaseAdapter {
    private List<ProductDisPlayCostDetailBean.RecordListBean> list;
    private Context context;

    public ProductDispalyDetailAdapter(Context context, List<ProductDisPlayCostDetailBean.RecordListBean> recordList) {
