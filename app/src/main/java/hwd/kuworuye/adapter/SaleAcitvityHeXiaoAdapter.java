 ...
 */
public class SaleAcitvityHeXiaoAdapter extends BaseAdapter {

    private List<QueryAllSaleHeXiaoListBean.PromotionEListBean.ListBean> list;
    private Context context;

    public SaleAcitvityHeXiaoAdapter(Context context, List<QueryAllSaleHeXiaoListBean.PromotionEListBean.ListBean> list) {
        this.list = list;
    ...
    public View getView(int i, View conview, ViewGroup viewGroup) {
        ...
        viewHolder.mTvSale.setText("销售额：¥" + list.get(i).getSalesVolume());
        return conview;
    }
